...
title: Gewichteter RankerCompatible with Milvus 2.6.x
summary: >-
...
beta: Milvus 2.6.x
---
<h1 id="Weighted-Ranker" class="common-anchor-header">Gewichteter Ranker<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.x</span><button data-href="#Weighted-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Apply-to-hybrid-search" class="common-anchor-header">Anwendung auf die hybride Suche</h3><p>Der Weighted Ranker wurde speziell für hybride Suchvorgänge entwickelt, die mehrere Vektorfelder kombinieren. Bei der hybriden Suche müssen Sie die Gewichte für jeden Suchpfad angeben:</p>
<div class="multipleCode">
