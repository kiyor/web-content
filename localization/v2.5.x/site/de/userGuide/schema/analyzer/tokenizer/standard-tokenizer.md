...
<h1 id="Standard-Tokenizer" class="common-anchor-header">Standard-Tokenisierer<button data-href="#Standard-Tokenizer" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Der <code translate="no">standard</code> Tokenizer in Milvus trennt Text auf der Grundlage von Leerzeichen und Satzzeichen und ist daher für die meisten Sprachen geeignet.</p>
