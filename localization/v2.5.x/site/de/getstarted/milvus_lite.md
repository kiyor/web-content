...
<h2 id="Migrating-data-from-Milvus-Lite" class="common-anchor-header">Migration von Daten aus Milvus Lite<button data-href="#Migrating-data-from-Milvus-Lite" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Alle in Milvus Lite gespeicherten Daten können einfach exportiert und in andere Milvus-Bereitstellungsarten geladen werden, z. B. Milvus Standalone auf Docker, Milvus Distributed auf K8s oder voll verwaltetes Milvus auf <a href="https://zilliz.com/cloud">Zilliz Cloud</a>.</p>
