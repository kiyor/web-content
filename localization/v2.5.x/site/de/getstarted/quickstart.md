...
<button class="copy-code-btn"></button></code></pre>
<p>Um Daten von Milvus Lite zu Milvus, das auf Docker oder Kubernetes bereitgestellt wird, zu migrieren, lesen Sie bitte <a href="https://github.com/milvus-io/milvus-lite?tab=readme-ov-file#migrating-data-from-milvus-lite">Migrieren von Daten von Milvus Lite</a>.</p>
