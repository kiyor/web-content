...
<ul>
<li><a href="https://milvus.io/docs/quickstart.md">dockerやkubernetes</a>上でよりパフォーマンスの高いMilvusサーバをセットアップすることができます。このセットアップでは、サーバアドレス、例えば<code translate="no">http://localhost:19530</code> を<code translate="no">uri</code> としてください。</li>
