...
title: Añadir campos a una colección existente
summary: >-
...
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">Añadir campos a una colección existente<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
