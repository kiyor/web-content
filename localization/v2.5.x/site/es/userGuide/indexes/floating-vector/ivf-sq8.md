...
<li><p><strong>Normalización:</strong> Normalizar los valores del vector a un rango entre 0 y 1 utilizando la fórmula:</p>
<p>$$ \text{valor_normalizado} = \frac{\text{valor} - \text{min}} {{text{max}} - \text{min}} $$</p>
...
<li><p><strong>Compresión de 8 bits:</strong> Multiplicar el valor normalizado por 255 (el valor máximo para un entero de 8 bits) y redondear el resultado al entero más cercano. Esto comprime cada valor en una representación de 8 bits.</p></li>
</ol>
