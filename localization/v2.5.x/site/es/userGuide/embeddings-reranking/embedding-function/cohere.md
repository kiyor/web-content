...
<h2 id="Choose-an-embedding-model" class="common-anchor-header">Elija un modelo de incrustación<button data-href="#Choose-an-embedding-model" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Milvus soporta modelos de incrustación provistos por Cohere. A continuación se presentan los modelos de incrustación disponibles actualmente para una referencia rápida:</p>
<table>
   <tr>
