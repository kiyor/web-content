...
<li><p>각 쿼리 하위 벡터와 해당 코드북($2^{\textit{nbits}}$ 중심 포함)에 대해 모든 중심까지의 거리를 계산하고 저장합니다.</p></li>
