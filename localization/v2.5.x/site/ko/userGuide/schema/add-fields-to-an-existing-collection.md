...
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">기존 컬렉션에 필드 추가<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
