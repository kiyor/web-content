...
<li><p>بالنسبة لكل متجه فرعي للاستعلام ودفتر الرموز المقابل له (يحتوي على 2 ^{\نصه{nbits}}$، يتم حساب المسافات وتخزينها إلى جميع المراكز.</p></li>
<li><p>يؤدي هذا إلى إنشاء <code translate="no">m</code> جداول بحث، حيث يحتوي كل جدول على مسافات $2^{\\نص{nbits}}$.</p></li>
</ul></li>
