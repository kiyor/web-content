...
<p>
  <span class="img-wrapper">
    <img translate="no" src="/docs/v2.5.x/assets/exp-decay.png" alt="Exp Decay" class="doc-image" id="exp-decay" />
    <span>Exp Decay</span>
  </span>
</p>
...
<li><p>Take the exponent, which gives you a value between 0 and 1: $\exp(\lambda \cdot value)$.</p></li>
</ol>
