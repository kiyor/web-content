...
<h1 id="Length" class="common-anchor-header">Длина<button data-href="#Length" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Фильтр <code translate="no">length</code> удаляет лексемы, которые не соответствуют заданным требованиям по длине, позволяя контролировать длину лексем, сохраняемых при обработке текста.</p>
