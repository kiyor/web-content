...
title: Добавление полей в существующую коллекцию
summary: >-
  ...
  различных сценариях.
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">Добавление полей в существующую коллекцию<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
