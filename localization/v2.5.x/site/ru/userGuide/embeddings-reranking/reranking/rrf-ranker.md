...
<h3 id="Create-an-RRF-Ranker" class="common-anchor-header">Создание ранжировщика RRF</h3><p>После настройки коллекции с несколькими векторными полями создайте RRF Ranker с подходящим параметром сглаживания:</p>
