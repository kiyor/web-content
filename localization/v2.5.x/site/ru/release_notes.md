...
<h4 id="Local-Storage-V2" class="common-anchor-header">Локальное хранилище V2</h4><p>В Milvus 2.5 представлен новый формат локальных файлов, повышающий эффективность загрузки и запросов для скалярных данных, снижающий накладные расходы памяти и закладывающий основу для будущих оптимизаций.</p>
