...
<ul>
<li>En interne, Milvus indexe tous les champs numériques comme des doubles. Si une valeur numérique dépasse $2^{53}$, elle perd en précision et les requêtes sur ces valeurs hors plage peuvent ne pas correspondre exactement.</li>
</ul></li>
