...
title: Ajouter des champs à une collection existante
summary: >-
  ...
  pratiques.
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">Ajouter des champs à une collection existante<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<li><p>Les noms de champs doivent être uniques parmi les champs statiques.</p></li>
