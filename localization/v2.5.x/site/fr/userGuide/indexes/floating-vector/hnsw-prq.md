...
<li><p><strong>Recherche de candidats :</strong> Lors de la recherche, HNSW utilise les représentations comprimées pour parcourir le graphe et récupérer un ensemble de candidats. Cela permet de réduire considérablement le nombre de vecteurs à examiner.</p></li>
...
<p><strong>Valeur par défaut</strong>: <code translate="no">2</code></p></td>
   ...
   <tr>
     ...
     <td><p>Un indicateur booléen qui contrôle l'application d'une étape de raffinement pendant la recherche. L'affinage consiste à reclasser les résultats initiaux en calculant les distances exactes entre le vecteur de la requête et les candidats.</p></td>
