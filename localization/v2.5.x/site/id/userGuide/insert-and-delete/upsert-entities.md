...
<h2 id="Overview" class="common-anchor-header">Gambaran Umum<button data-href="#Overview" class="anchor-icon" translate="no">
    ...
    </button></h2><p>Ketika Anda perlu memperbarui Entitas dalam Koleksi atau tidak yakin apakah akan memperbarui atau menyisipkan, Anda dapat mencoba menggunakan operasi Upsert. Ketika menggunakan operasi ini, sangat penting untuk memastikan bahwa Entitas yang disertakan dalam permintaan Upsert berisi kunci utama; jika tidak, kesalahan akan terjadi. Setelah menerima permintaan Upsert, Milvus akan menjalankan proses berikut:</p>
<ol>
