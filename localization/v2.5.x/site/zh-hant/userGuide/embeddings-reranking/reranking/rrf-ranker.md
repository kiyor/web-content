---
id: rrf-ranker.md
title: RRF 排序器Compatible with Milvus 2.6.x
summary: >-
...
beta: Milvus 2.6.x
---
<h1 id="RRF-Ranker" class="common-anchor-header">RRF 排序器<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.x</span><button data-href="#RRF-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-an-RRF-Ranker" class="common-anchor-header">建立 RRF 排序器</h3><p>在您的資料集中設定了多個向量欄位之後，請使用適當的平滑參數建立 RRF Ranker：</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Apply-to-hybrid-search" class="common-anchor-header">應用於混合搜尋</h3><p>RRF Ranker 專為結合多向量欄位的混合搜尋作業而設計。以下是如何在混合搜尋中使用它：</p>
<div class="multipleCode">
