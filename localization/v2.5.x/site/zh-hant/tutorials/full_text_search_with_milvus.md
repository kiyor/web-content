...
<ul>
<li>目前，Milvus Standalone、Milvus Distributed 和 Zilliz Cloud 均提供全文檢索功能，但 Milvus Lite 尚未支援此功能（計畫在未來實施此功能）。如需更多資訊，請聯絡 support@zilliz.com。</li>
</ul>
</div>
...
<h3 id="Text-Analysis-Configuration" class="common-anchor-header">文字分析設定</h3><p>對於全文檢索，我們定義應該如何處理文字。分析器在全文檢索中是不可或缺的，它可將句子分割成標點，並執行詞彙分析，例如詞幹和停止詞移除。在此，我們只需定義一個分析器。</p>
