...
<p>A função BM25 converte automaticamente o conteúdo do texto em vectores esparsos, permitindo que o Milvus lide com a complexidade da pesquisa de texto completo sem exigir a geração manual de incorporação esparsa.</p>
