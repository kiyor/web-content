---
id: rrf-ranker.md
title: Classificador RRFCompatible with Milvus 2.6.x
summary: >-
...
beta: Milvus 2.6.x
---
<h1 id="RRF-Ranker" class="common-anchor-header">Classificador RRF<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.x</span><button data-href="#RRF-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<h3 id="Create-an-RRF-Ranker" class="common-anchor-header">Criar um classificador RRF</h3><p>Depois que sua coleção for configurada com vários campos vetoriais, crie um RRF Ranker com um parâmetro de suavização apropriado:</p>
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Apply-to-hybrid-search" class="common-anchor-header">Aplicar à pesquisa híbrida</h3><p>O RRF Ranker foi projetado especificamente para operações de pesquisa híbrida que combinam vários campos vetoriais. Veja como usá-lo em uma busca híbrida:</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<p>Para obter mais informações sobre pesquisa híbrida, consulte <a href="/docs/pt/multi-vector-search.md">Pesquisa Híbrida Multi-Vetorial</a>.</p>
