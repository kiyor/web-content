...
<li><p>Subtrair o desvio (se houver), mas nunca abaixo de zero: $\max(0, distância - desvio)$.</p></li>
<li><p>Multiplique por $\lambda$, que é calculado a partir dos seus parâmetros de escala e decaimento.</p></li>
<li><p>Pegue no expoente, que lhe dá um valor entre 0 e 1: $\exp(\lambda \cdot value)$.</p></li>
</ol>
<p>O cálculo de $\lambda$ converte seus parâmetros de escala e decaimento no parâmetro de taxa para a função exponencial. Um $\lambda$ mais negativo cria uma queda inicial mais acentuada.</p>
<h2 id="Use-exponential-decay" class="common-anchor-header">Usar o decaimento exponencial<button data-href="#Use-exponential-decay" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
