...
title: Classificador ponderadoCompatible with Milvus 2.6.x
summary: >-
...
beta: Milvus 2.6.x
---
<h1 id="Weighted-Ranker" class="common-anchor-header">Classificador ponderado<span class="beta-tag" style="background-color:rgb(0, 179, 255);color:white" translate="no">Compatible with Milvus 2.6.x</span><button data-href="#Weighted-Ranker" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
...
<button class="copy-code-btn"></button></code></pre>
<h3 id="Apply-to-hybrid-search" class="common-anchor-header">Aplicar à pesquisa híbrida</h3><p>O Weighted Ranker foi concebido especificamente para operações de pesquisa híbrida que combinam vários campos vectoriais. Ao efetuar uma pesquisa híbrida, é necessário especificar os pesos para cada caminho de pesquisa:</p>
<div class="multipleCode">
...
<button class="copy-code-btn"></button></code></pre>
<p>Para obter mais informações sobre a pesquisa híbrida, consulte <a href="/docs/pt/multi-vector-search.md">Pesquisa híbrida multivetorial</a>.</p>
