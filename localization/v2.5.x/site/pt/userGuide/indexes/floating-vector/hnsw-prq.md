...
<li><p><strong>Recuperação de candidatos:</strong> Durante a pesquisa, o HNSW utiliza as representações comprimidas para percorrer o grafo e recuperar um conjunto de candidatos. Isto reduz drasticamente o número de vectores que precisam de ser considerados.</p></li>
