...
title: Adicionar campos a uma coleção existente
summary: >-
...
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">Adicionar campos a uma coleção existente<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
