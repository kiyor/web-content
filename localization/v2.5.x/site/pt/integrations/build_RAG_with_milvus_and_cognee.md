...
<p>Por predefinição, neste exemplo, é utilizado o OpenAI como LLM. Deve preparar a <a href="https://platform.openai.com/docs/quickstart">chave api</a> e defini-la na função config <code translate="no">set_llm_api_key()</code>.</p>
...
<h2 id="Build-RAG" class="common-anchor-header">Construir o RAG<button data-href="#Build-RAG" class="anchor-icon" translate="no">
    ...
    </button></h2><h3 id="Resetting-Cognee-Data" class="common-anchor-header">Repor os dados do Cognee</h3><pre><code translate="no" class="language-python"><span class="hljs-keyword">await</span> cognee.prune.prune_data()
