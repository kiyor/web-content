...
<h2 id="Searching-book-titles-with-OpenAI--Milvus" class="common-anchor-header">Pesquisa de títulos de livros com o OpenAI e o Milvus<button data-href="#Searching-book-titles-with-OpenAI--Milvus" class="anchor-icon" translate="no">
    ...
    </button></h2><p>No exemplo seguinte, carregamos os dados do título do livro a partir do ficheiro CSV descarregado, utilizamos o modelo de incorporação OpenAI para gerar representações vectoriais e armazenamo-las na base de dados vetorial Milvus para pesquisa semântica.</p>
