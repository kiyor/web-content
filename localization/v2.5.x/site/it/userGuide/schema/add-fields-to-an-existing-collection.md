...
title: Aggiungere campi a una raccolta esistente
summary: >-
...
---
<h1 id="Add-Fields-to-an-Existing-Collection" class="common-anchor-header">Aggiungere campi a una raccolta esistente<button data-href="#Add-Fields-to-an-Existing-Collection" class="anchor-icon" translate="no">
      <svg translate="no"
        aria-hidden="true"
        focusable="false"
        height="20"
