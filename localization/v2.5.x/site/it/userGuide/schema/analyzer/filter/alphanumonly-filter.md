...
<h1 id="Alphanumonly" class="common-anchor-header">Solo alfanumerico<button data-href="#Alphanumonly" class="anchor-icon" translate="no">
    ...
    </button></h1><p>Il filtro <code translate="no">alphanumonly</code> rimuove i token che contengono caratteri non ASCII, mantenendo solo i termini alfanumerici. Questo filtro è utile per elaborare testi in cui sono rilevanti solo lettere e numeri di base, escludendo caratteri speciali o simboli.</p>
