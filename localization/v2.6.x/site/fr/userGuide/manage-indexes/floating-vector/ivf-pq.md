...
<li><p>Pour chaque sous-vecteur de requête et son livre de codes correspondant (contenant $2^{\textit{nbits}}$ centroïdes), les distances entre tous les centroïdes sont calculées et stockées.</p></li>
