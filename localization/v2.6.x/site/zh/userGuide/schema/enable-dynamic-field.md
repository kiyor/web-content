...
<li><p>将该键的<strong>JSON 路径指定</strong>为<code translate="no">json_path</code> 。由于动态字段存储为 JSON 格式，因此可以指定类似<code translate="no">&quot;color&quot;</code> 这样的路径，如果有嵌套结构，则可以指定更深的路径（例如<code translate="no">my_json[&quot;field&quot;][&quot;subfield&quot;]</code> ）。</p></li>
